...
public class ventana extends JFrame {
	...
	public ventana() {
		...
		setContentPane(contentPane); // Establece el panel de contenido como el panel principal de la ventana.
                ...
                progressBar.setBounds(25, 620, 971, 20);
		...
		panelContactos.add(btn_eliminar);
                txt_email.addActionListener(e -> btn_add.doClick());
                
                btn_exportar = new JButton("EXPORTAR CSV");
                btn_exportar.setBounds(25, 200, 180, 30);
		...
		modeloTabla = new DefaultTableModel();
                modeloTabla.setColumnIdentifiers(new String[]{
                    "Nombre", "Teléfono", "Email", "Categoría", "Favorito"
                });
		...
		logica_ventana lv=new logica_ventana(this);
                ...
                JMenuItem itemInfo = new JMenuItem("Ver información");
                menu.add(itemInfo);
